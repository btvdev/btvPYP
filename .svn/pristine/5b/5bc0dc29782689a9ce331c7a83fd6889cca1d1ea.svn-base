...
public class TabSample implements Serializable{
	...
	private String    columnType;    //栏目类别   adv.广告 lm.栏目 xc.宣传片
	private String    advId;         //广告ID
	private String    fileAddr;      //上传文件的地址
	private Integer   extFlag;       //提取标志  0.未提取 1.提取中 2.提取失败 3.提取成功
	...
	private Integer   clarity;       //清晰度  1.标清 2.高清
	private Integer   original;      //是否原版  1.是 0.带台标
	private Integer   brandId;       //品牌号(特雷森专用)
	private String    firstDate;     //首播日期
	private String    firstTime;     //首播时间
