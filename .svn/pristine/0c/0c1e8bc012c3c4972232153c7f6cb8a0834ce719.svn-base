...
<%-- 						<td nowrap="nowrap">${p.sampleMatchId }</td> --%>
						<td nowrap="nowrap" name="tdsampleId">${p.sampleId }
...
<script language="javascript">
    ...
    function search(){
    	$("#searchForm").attr("action", "<%=request.getContextPath()%>/tabSampleMatch/searchManual");
    	$("#searchForm").submit();
    }
    ...
    /*
  	...
  	*/
  	...
  	function updateOne(id){
  		window.location.href="<%=request.getContextPath()%>/tabSampleMatch/"+id+"/update";
  	}
